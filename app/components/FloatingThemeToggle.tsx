...
export default function FloatingThemeToggle() {
    ...
    const lightModeLogo = <div id="btn-theme-light" className="fixed z-99 bottom-5 right-10 flex items-center justify-center w-12 h-12 rounded-full bg-[#1e40af] shadow cursor-pointer text-[#fbbf24] hover:text-white hover-glow">
        <svg id="icon-light-mode" xmlns="http://www.w3.org/2000/svg" height="1.7em" fill="currentColor" viewBox="0 0 512 512">
            <path
    ...
    const darkModeLogo = <div id="btn-theme-dark" className="fixed z-99 bottom-5 right-10 flex items-center justify-center w-12 h-12 rounded-full bg-[#1e40af] shadow cursor-pointer text-white hover:bg-[#fbbf24] hover:text-[#1e40af] hover-glow">
        <svg id="icon-dark-mode" xmlns="http://www.w3.org/2000/svg" height="1.7em" fill="currentColor" viewBox="0 0 512 512">
            <path
    ...
    return <div id="theme-toggle-wrapper" onClick={handleToggleDarkMode}>
