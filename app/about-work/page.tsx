        ...
        <div className="glass-card rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8 border-l-4 border-blue-500 pl-6">
            ...
            <div className="bg-blue-50 rounded-lg p-6">
              ...
              <p className="mb-3" style={{ color: 'var(--text-secondary)' }}>77 Global Services Inc. | August 2024 - Present</p>
          ...
          {/* Previous Roles */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-green-600 mb-4">Previous Roles</h2>
            <div className="space-y-6">
              <div className="bg-green-50 rounded-lg p-6">
                <h3 className="text-xl font-medium mb-2" style={{ color: 'var(--text-primary)' }}>
                  Frontend Developer
                </h3>
                <p className="mb-3" style={{ color: 'var(--text-secondary)' }}>GHD | May 2023 - August 2024</p>
                <p className="leading-relaxed" style={{ color: 'var(--text-primary)' }}>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <p className="mb-3" style={{ color: 'var(--text-secondary)' }}>Vertere Global Solutions Inc. | June 2022 - April 2023</p>
                <p className="leading-relaxed" style={{ color: 'var(--text-primary)' }}>
              ...
              <div className="bg-green-50 rounded-lg p-6">
                ...
                <p className="mb-3" style={{ color: 'var(--text-secondary)' }}>March 2020 - April 2022</p>
                <p className="leading-relaxed" style={{ color: 'var(--text-primary)' }}>
          ...
          {/* Technical Skills */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-purple-600 mb-4">Core Technical Skills</h2>
          ...
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-blue-600 mb-4">AI-First Development</h2>
            <div className="bg-blue-50 rounded-lg p-6">
              <p className="leading-relaxed" style={{ color: 'var(--text-primary)' }}>
          ...
          {/* Soft Skills */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-green-600 mb-4">Soft Skills</h2>
            <div className="bg-green-50 rounded-lg p-6">
              <p className="leading-relaxed" style={{ color: 'var(--text-primary)' }}>
          ...
          {/* Certifications */}
          <div className="mb-8">
            <h2 className="text-2xl font-semibold text-orange-600 mb-4">Certifications & Training</h2>
            <div className="bg-orange-50 rounded-lg p-6">
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Certified Lean Six Sigma White Belt</h4>
                  <p style={{ color: 'var(--text-secondary)' }}>Six Sigma PH | February 2025</p>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Reference: https://sixsigma.freshlearn.com/certificate/1556969</p>
                </div>
                <div>
                  <h4 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Basics of UI Design</h4>
                  <p style={{ color: 'var(--text-secondary)' }}>Cambridge International Qualifications, UK | February 2025</p>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Reference: https://uniathena.com/verify/certificate?certID=1370-7221-9127</p>
                </div>
                <div>
                  <h4 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Odoo v14 Software Development Training & Ionic Mobile Application Development</h4>
                  <p style={{ color: 'var(--text-secondary)' }}>Megawide Construction Corp. | December 2023</p>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Conducted by Candidoskie P. Berdin II, Senior IT Manager</p>
                </div>
                <div>
                  <h4 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Google Cloud Big Data and Machine Learning Fundamentals</h4>
                  <p style={{ color: 'var(--text-secondary)' }}>Google Cloud | August 2020 | Grade: 97.30%</p>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Reference: https://coursera.org/verify/UUQXGLPDM3VJ2019-2022</p>
                </div>
                <div>
                  <h4 className="font-semibold" style={{ color: 'var(--text-primary)' }}>Introduction to TensorFlow for AI, ML, and Deep Learning</h4>
                  <p style={{ color: 'var(--text-secondary)' }}>Deeplearning.AI | August 2020 | Grade: 97.82%</p>
                  <p className="text-sm" style={{ color: 'var(--text-secondary)' }}>Reference: https://coursera.org/verify/FFHG8BC72NKZ</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <h2 className="text-2xl font-semibold mb-4" style={{ color: 'var(--text-primary)' }}>Professional Journey</h2>
            <p className="leading-relaxed mb-4" style={{ color: 'var(--text-primary)' }}>
